...
public class DKBKPSPublicSoap
{
    interface DKBIWcfMethod
    {
        DKBExtendedSoapSerializationEnvelope CreateSoapEnvelope() throws java.lang.Exception;

        java.lang.Object ProcessResult(DKBExtendedSoapSerializationEnvelope __envelope,java.lang.Object result) throws java.lang.Exception;
    }
    ...
    public DKBKPSPublicSoap(){}

    public DKBKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public DKBKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    protected DKBExtendedSoapSerializationEnvelope createEnvelope()
    {
        DKBExtendedSoapSerializationEnvelope envelope= new DKBExtendedSoapSerializationEnvelope(DKBExtendedSoapSerializationEnvelope.VER11);
        envelope.enableLogging = enableLogging;
    
        return envelope;
    }

    protected java.util.List sendRequest(String methodName,DKBExtendedSoapSerializationEnvelope envelope,org.ksoap2.transport.Transport transport ,com.easywsdl.exksoap2.ws_specifications.profile.WS_Profile profile )throws java.lang.Exception
    {
    ...
    java.lang.Object getResult(java.lang.Class destObj,java.lang.Object source,String resultName,DKBExtendedSoapSerializationEnvelope __envelope) throws java.lang.Exception
    {
        if(source==null)
        {
            return null;
    ...
    public Boolean TCKimlikNoDogrula(final String TCKimlikNo, final String Ad, final String Soyad, final Date DogumYili) throws java.lang.Exception
    {
        ...
        return (Boolean)execute(new DKBIWcfMethod()
        {
            @Override
            public DKBExtendedSoapSerializationEnvelope CreateSoapEnvelope(){
                DKBExtendedSoapSerializationEnvelope __envelope = createEnvelope();
            ...
            @Override
            public java.lang.Object ProcessResult(DKBExtendedSoapSerializationEnvelope __envelope,java.lang.Object __result)throws java.lang.Exception {
    ...
    protected java.lang.Object execute(DKBIWcfMethod wcfMethod,String methodName,com.easywsdl.exksoap2.ws_specifications.profile.WS_Profile profile) throws java.lang.Exception
    {
        org.ksoap2.transport.Transport __httpTransport=createTransport();
        __httpTransport.debug=enableLogging;
        DKBExtendedSoapSerializationEnvelope __envelope=wcfMethod.CreateSoapEnvelope();
        try
        {
    ...
    protected java.lang.Exception convertToException(org.ksoap2.SoapFault fault,DKBExtendedSoapSerializationEnvelope envelope)
    {
