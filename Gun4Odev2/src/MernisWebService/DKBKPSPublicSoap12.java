...
public class DKBKPSPublicSoap12
{
    ...
    public DKBKPSPublicSoap12(){}

    public DKBKPSPublicSoap12(String url)
    {
        this.url = url;
    }

    public DKBKPSPublicSoap12(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        DKBExtendedSoapSerializationEnvelope envelope= new DKBExtendedSoapSerializationEnvelope(DKBExtendedSoapSerializationEnvelope.VER12);
