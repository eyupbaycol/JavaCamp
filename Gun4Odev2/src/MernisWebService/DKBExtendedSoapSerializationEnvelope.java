...
public class DKBExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(DKBDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new DKBStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static DKBDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static DKBDateTimeConverter dateTimeConverter = new DKBStandardDateTimeConverter();

    public DKBExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public DKBExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new DKBMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=DKBHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,DKBExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=DKBHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
